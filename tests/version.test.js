...
test('release metadata and user-visible fallbacks are 3.9.0', () => {
  ...
  assert.equal(webPkg.version, '3.9.0');
  assert.match(html, /Version 3\.9\.0/);
  assert.match(about, /3\.9\.0/);
  assert.match(shell, /v3\.9\.0/);
