...
test('web auth talks only to the Coach Intel Supabase project', () => {
  ...
  assert.match(gate, /invite-pass-marks/);
  assert.match(gate, /invite-pass-body/);
  ...
  assert.doesNotMatch(gate, /splash-slogan/);
  assert.doesNotMatch(gate, /signin-slogan/);
  assert.match(gate, /has-pass/);
...
test('signed-in shell reads teams and members from Supabase', () => {
  ...
  assert.doesNotMatch(read('components/desktop-nav.js'), /sb-lockup/);
  assert.doesNotMatch(read('components/desktop-nav.js'), /sb-mark/);
  assert.doesNotMatch(read('components/desktop-nav.js'), /splash-logo\.png/);
